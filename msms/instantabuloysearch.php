...
$instantabuloy = $con->query($sql) or die ($con->connect_error);
$row = $instantabuloy->fetch_assoc();

$total = $instantabuloy->num_rows;
    
if($total>0){
}else{
    echo header("Location: instantabuloy.php");
}
...
.dropdown:hover .dropdown-content {
  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <form action ="instantabuloysearch.php" method="get">
        <table>
        ...
        <table class="table custom-table">
          ...
          <tbody>
            ...
            <?php if($row['Status'] == "Closed" || $row['Status'] == "Renewed"){
              ...
              <td><a href="instantabuloyform.php?AccountNumber=<?php echo $row['account_number'];?>"><i class="fa fa-caret-square-o-right" style="font-size:24px;color:green"></i></td>
            ...
            <?php }while($row = $instantabuloy->fetch_assoc())?> 
          </tbody>
        </table>
      </div>
