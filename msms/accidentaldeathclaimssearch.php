...
$accidentaldeathclaims = $con->query($sql) or die ($con->connect_error);
$row = $accidentaldeathclaims->fetch_assoc();

$total = $accidentaldeathclaims->num_rows;
    
if($total>0){
}else{
    echo header("Location: accidentaldeathclaims.php");
}
...
.dropdown:hover .dropdown-content {
  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <form action ="accidentaldeathclaimssearch.php" method="get">
        <table>
        ...
        <table class="table custom-table">
          ...
          <tbody>
            ...
            echo " ";
              ...
              <td><a href="accidentaldeathclaimsform.php?AccountNumber=<?php echo $row['account_number'];?>"><i class="fa fa-caret-square-o-right" style="font-size:24px;color:green"></i></td>
         ...
         <?php } ?>
            ...
            <?php }while($row = $accidentaldeathclaims->fetch_assoc())?> 
          </tbody>
        </table>
      </div>
