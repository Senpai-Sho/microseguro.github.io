...
h3,h1 ,h4{
  ...
  <form action="exportclaimsaccount.php" method="POST">
...
<H3>MICRO SEGURO CLAIMS PRODUCTS </H3></th>
      ...
      <td><a href="addclaimsaccount.php"><i class="fa fa-file-text-o" style="font-size:30px;color:green"></i></a>  &nbsp;  &nbsp;</td>
      <?php } ?>   
        ...
        <table class="table custom-table">
          ...
          <tbody>
            ...
            <tr scope="row"> 
              ...
              <?php if($_SESSION['Access'] == "MS Master" || $_SESSION['Access'] == "Developer"){?>
                <td><a href="updateclaimsaccount.php?ClaimsID=<?php echo $row['claims_id'];?>"><i class="fa fa-toggle-up" style="font-size:25px;color:green"></i></a></td>
                <?php } ?>
      
                <?php if($_SESSION['Access'] == "MS Master"|| $_SESSION['Access'] == "Developer"){?>
                  <form action="deleteclaimsaccount.php" method="post">
                ...
                <td><input type="hidden" name="ClaimsID" value = "<?php echo $row['claims_id'];?>"> 
                </form>
                <?php }?>
...
function checker(){
  ...
  var result = confirm('ARE YOU SURE YOU WANT TO DELETE THIS CLAIMS ACCOUNT ?');
