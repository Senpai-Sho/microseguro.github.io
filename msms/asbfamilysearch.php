...
$asbfamily = $con->query($sql) or die (con->connect_error);
$row = $asbfamily->fetch_assoc();

$total = $asbfamily->num_rows;

if($total>0) {
}
else { 
  echo header("Location: asbfamily.php");
}
...
.dropdown:hover .dropdown-content {
  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <form action ="asbfamilysearch.php" method="get">
        <table>
          ...
          <tbody>
            ...
            <td></td>
              ...
              <td><?php echo$row['last_name'],',  ',$row['first_name'],'  ',$row['middle_initial']?></td>
                    <td><a href="asbfamilyform.php?AccountNumber=<?php echo $row['account_number'];?>"><i class="fa fa-caret-square-o-right" style="font-size:24px;color:green"></i></td>
                    <td></td>
            <td></td>
            <td></td>
            ...
            <?php }while($row = $asbfamily->fetch_assoc())?> 
          </tbody>
        </table>
      </div>
