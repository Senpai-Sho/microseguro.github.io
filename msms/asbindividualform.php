...
$sql = "INSERT INTO `cb_kalinga`(`account_number`,`full_name`,`b_firstname`,`b_lastname`,`b_middlename`,`b_middleinitial`,`b_relationship`,`b_birthday`,`Status`)
...
$sql="SELECT * FROM insurance_product WHERE product_id = '004' ";
...
<h2>ALALAY SA BUHAY (INDIVIDUAL) </h2>
...
<table>
  ...
  <tr>
    ...
    <td> <input type="text" value="<?php echo $row['account_number'];?>"   id="accountnumber" name="accountnumber" autocomplete="off" READONLY > <a href="asbindividual.php"><i class="fa fa-file-text-o" style="font-size:20px;color:green"></i></a></td>
    <td>Member Name:</td>
