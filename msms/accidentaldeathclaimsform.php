...
`membership_type`,`claims_type`,`member_diagnos`,`death_date`,`kps_share`,
`cblic_share`,`member_explanation`,`form_code`,`branch_name`)
 VALUES('$account','$fname','$approval','$form','$patient','$membertype','$claimtype',
 '$diagnos','$death','$kps','$cblic','$explain','$formcode','$branch')";
...
$sql1 = "SELECT * FROM claims_data WHERE claims_id = '005'";
...
<table>
 ...
 <input type="hidden" value="<?php echo $row['full_name'];?>"   id="fullname" name="fullname" autocomplete="off" READONLY > 
  ...
  <tr>
    ...
    <td><b><?php echo $row['account_number'];?> &nbsp <a href="accidentaldeathclaims.php"><i class="fa fa-file-text-o" style="font-size:20px;color:green"></i></b></a></td>
    <td>Member Name:</td>
...
<td>Diagnosis</td>
<td><input type="text" id="diagnos" name="diagnos" autocomplete="off">
...
<td>Date of Death</td>
<td><input type="date" name="dateofdeath" class="form-control">
...
<td>Explanation</td>
<td><input type="text" name="explanation"  id="explanation" autocomplete="off"></td>
</tr>
...
function checker(){
  ...
  var result = confirm('DO YOU WANT TO SAVE THIS ACCIDENTAL DEATH CLAIMS FORM?');
