...
$sql2 = "SELECT * FROM insurance_product WHERE product_id = '$productaccount'";
...
if(isset($_POST['submit'])){
    ...
    if (count($errors) == 0){
        ...
        $sql1 = "UPDATE insurance_product SET product_id = '$productid', product_name ='$productname', classification = '$class'
