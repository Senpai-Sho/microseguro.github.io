...
h3,h1 ,h4{
  ...
  <form action="exportkpsproducts.php" method="POST">
...
<H3>MICRO SEGURO KPS-SEED LOAN PRODUCTS </H3></th>
      ...
      <td><a href="addkpsproducts.php"><i class="fa fa-file-text-o" style="font-size:30px;color:green"></i></a>  &nbsp;  &nbsp;</td>
      <?php } ?>   
        ...
        <table class="table custom-table">
          ...
          <tbody>
            ...
            <tr scope="row"> 
              ...
              <?php if($_SESSION['Access'] == "MS Master" || $_SESSION['Access'] == "Developer"){?>
                <td><a href="updatekpsproducts.php?ProductID=<?php echo $row['product_id'];?>"><i class="fa fa-toggle-up" style="font-size:25px;color:green"></i></a></td>
                <?php } ?>
      
                <?php if($_SESSION['Access'] == "MS Master"|| $_SESSION['Access'] == "Developer"){?>
                  <form action="deletekpsproducts.php" method="post">
...
function checker(){
  ...
  var result = confirm('ARE YOU SURE YOU WANT TO DELETE THIS KPS PRODUCT ?');
