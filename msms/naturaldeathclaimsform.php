...
`cblic_share`,`member_explanation`,`form_code`,`branch_name`)VALUES('$account','$fname','$approval','$form','$patient','$membertype','$claimtype',
...
$sql1 = "SELECT * FROM claims_data WHERE claims_id = '004'";
...
<table>
 ...
 <input type="hidden" value="<?php echo $row['full_name'];?>"   id="fullname" name="fullname" autocomplete="off" READONLY > 
  ...
  <tr>
    ...
    <td><b><?php echo $row['account_number'];?> &nbsp <a href="naturaldeathclaims.php"><i class="fa fa-file-text-o" style="font-size:20px;color:green"></i></b></a></td>
    <td>Member Name:</td>
...
function checker(){
  ...
  var result = confirm('DO YOU WANT TO SAVE THIS NATURAL DEATH CLAIMS FORM?');
