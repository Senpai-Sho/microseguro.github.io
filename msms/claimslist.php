...
$sql = "SELECT * FROM member_info ORDER BY account_number DESC";
...
.dropdown:hover .dropdown-content {
  ...
  <ul>
  <li><a href="claimsselect.php"><i class='fas fa-caret-square-left' style='font-size:24px;color:green'></i></a></li>
        ...
        <table class="table custom-table">
          ...
          <tbody>
            ...
            <tr scope="row"> 
              ...
              <td><a href="updateclaims.php?AccountNumber=<?php echo $row['account_number'];?>"><i class="fa fa-caret-square-o-right" style="font-size:24px;color:green"></i></td>
