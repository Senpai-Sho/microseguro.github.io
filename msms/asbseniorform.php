...
$sql="SELECT * FROM insurance_product WHERE product_id = '003' ";
...
<table>
  ...
  <tr>
    ...
    <td> <input type="text" value="<?php echo $row['account_number'];?>"   id="accountnumber" name="accountnumber" autocomplete="off" READONLY > <a href="asbsenior.php"><i class="fa fa-file-text-o" style="font-size:20px;color:green"></i></a></td>
    <td>Member Name:</td>
