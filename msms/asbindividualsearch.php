...
$asbindividual = $con->query($sql) or die (con->connect_error);
$row = $asbindividual->fetch_assoc();

$total = $asbindividual->num_rows;

if($total>0) {
}
else { 
  echo header("Location: asbindividual.php");
}
...
.dropdown:hover .dropdown-content {
  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <form action ="asbindividualsearch.php" method="get">
        <table>
          ...
          <tbody>
            ...
            <td></td>
              ...
              <td><?php echo$row['last_name'],',  ',$row['first_name'],'  ',$row['middle_initial']?></td>
                    <td><a href="asbindividualform.php?AccountNumber=<?php echo $row['account_number'];?>"><i class="fa fa-caret-square-o-right" style="font-size:24px;color:green"></i></td>
                    <td></td>
            <td></td>
            <td></td>
            ...
            <?php }while($row = $asbindividual->fetch_assoc())?> 
          </tbody>
        </table>
      </div>
