...
h3,h1 ,h4{
  ...
  <form action="exportclaimsperbranch.php" method="POST">
...
<H3>MICRO SEGURO CLAIMS DISBURSEMENT PER BRANCH REPORT </H3></th>
...
<form action="" method="GET">
      ...
      <?php if(isset($_GET['from_date']) && isset($_GET['to_date']) && isset($_GET['claims'])  && isset($_GET['branchname']) ){
