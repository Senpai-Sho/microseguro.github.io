...
$sql="SELECT * FROM insurance_product WHERE product_id = '001' ";
...
if(empty($brelation)){
  ...
  if (count($errors)==0){
    ...
    $sql4 ="UPDATE cb_form SET account_number = '$account', full_name = '$fname', cb_number = '$nocb', date_insured = '$insured' WHERE account_number = '$accountnumber' ";
  ...
  loan_product = '$loan', number_cb = '$nocb' , membership_status = '$msinfo' , date_insured = '$insured', renewal = '$renewal', branch_name ='$branch',
  coc = '$coc', length = '$lengths', unit = '$unit', dayoflength = '$dayoflength'  WHERE account_number = '$accountnumber' ";
  $con->query($sql) or die ($con->error);

  $sql = "UPDATE cb_kalinga SET account_number = '$account', full_name = '$fname', b_firstname ='$bfname',
  b_lastname = '$blname', b_middlename = '$bmname', b_middleinitial = '$bminitial',b_relationship = '$brelation',
  b_birthday = '$bbdate'  WHERE account_number = '$accountnumber'";
  $con->query($sql) or die ($con->error);
  

  if($row['product_type'] == "CBK-Member"|| $row['product_type'] == "CBK-Pension" || $row['product_type'] == "ASB-Family"){
$sql = "UPDATE cb_kalinga SET 
   m_firstname = '$mfname', m_lastname = '$mlname', m_middlename = '$mmname',
  m_birthday = '$mbdate', c1_firstname = '$c1fname', c1_lastname = '$c1lname', c1_middlename = '$c1mname',
  c1_birthday= '$c1bdate', c2_firstname = '$c2fname', c2_lastname = '$c2lname', c2_middlename = '$c2mname',
  c2_birthday= '$c2bdate', c3_firstname = '$c3fname', c3_lastname = '$c3lname', c3_middlename = '$c3mname',
  c3_birthday= '$c3bdate', a1_firstname = '$a1fname', a1_lastname = '$a1lname', a1_middlename = '$a1mname',
  a1_birthday= '$a1bdate', a1_relationship = '$a1relation', a2_firstname = '$a2fname', a2_lastname = '$a2lname',
  a2_middlename = '$a2mname', a2_birthday = '$a2bdate', a2_relationship = '$a2relation', a3_firstname = '$a3fname',
  a3_lastname = '$a3lname', a3_middlename = '$a3mname',a3_birthday = '$a3bdate', a3_relationship = '$a3relation',
   a4_firstname = '$a4fname', a4_lastname = '$a4lname', a4_middlename = '$a4mname',a4_birthday = '$a4bdate', a4_relationship = '$a4relation'
  ...
  echo header("location:memberproduct.php?AccountNumber=".$accountnumber);
...
<td><select id="id" name="memstatus">
  <option value="<?php echo $row['membership_status']?>"><?php echo $row['membership_status']?></option>
  <?php do{?>
    <option value="<?php echo $row5['membership_name']?>"><?php echo $row5['membership_name']?></option>
   
  <?php } while ($row5= $membershipinfo->fetch_assoc())?>
  </select>
  </td>
...
<tr>
  ...
  <td><input type ="number" id="length" value="<?php echo $row['length']?>" name="length" min="1" max="99"   autocomplete="off"> 
      <select id="id" name="dyoflength">
      <option value="<?php echo $row['dayoflength']?>"><?php echo $row['dayoflength']?></option>
