...
h3,h1 ,h4{
  ...
  <form action="exportmstobranch.php" method="POST">
...
<H3>MICRO SEGURO INSURANCE PRODUCT PER BRANCH REPORT </H3></th>
...
$query = "SELECT * FROM member_info WHERE date_insured BETWEEN '$from_date' AND '$to_date' AND product_type = '$productinfo' AND branch_name = '$branchname'";
