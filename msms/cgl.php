...
.dropdown:hover .dropdown-content {
  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <h2 class="mb-5">Select Account (CGL-Loan Insurance) </h2>

      <form action ="cglsearch.php" method="get">
        <table>
          ...
          <tbody>
            ...
            <td></td>
              ...
              <td><?php echo$row['last_name'],',  ',$row['first_name'],'  ',$row['middle_initial']?></td>
                    <td><a href="cglform.php?AccountNumber=<?php echo $row['account_number'];?>"><i class="fa fa-caret-square-o-right" style="font-size:24px;color:green"></i></td>
                    <td></td>
            <td></td>
            <td></td>
