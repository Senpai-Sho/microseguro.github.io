...
$sql1 = "SELECT * FROM claims_data WHERE claims_id = '003'";
...
<table>
 ...
 <input type="hidden" value="<?php echo $row['full_name'];?>"   id="fullname" name="fullname" autocomplete="off" READONLY > 
  ...
  <tr>
    ...
    <td><b><?php echo $row['account_number'];?> &nbsp <a href="instantabuloy.php"><i class="fa fa-file-text-o" style="font-size:20px;color:green"></i></b></a></td>
    <td>Member Name:</td>
...
function checker(){
  ...
  var result = confirm('DO YOU WANT TO SAVE THIS INSTANT ABULOY FORM?');
