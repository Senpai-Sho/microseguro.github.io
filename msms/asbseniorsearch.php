...
$asbsenior = $con->query($sql) or die (con->connect_error);
$row = $asbsenior->fetch_assoc();

$total = $asbsenior->num_rows;

if($total>0) {
}
else { 
  echo header("Location: asbsenior.php");
}
...
.dropdown:hover .dropdown-content {
  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <form action ="asbseniorsearch.php" method="get">
        <table>
          ...
          <tbody>
            ...
            <td></td>
              ...
              <td><?php echo$row['last_name'],',  ',$row['first_name'],'  ',$row['middle_initial']?></td>
                    <td><a href="asbseniorform.php?AccountNumber=<?php echo $row['account_number'];?>"><i class="fa fa-caret-square-o-right" style="font-size:24px;color:green"></i></td>
                    <td></td>
            <td></td>
            <td></td>
            ...
            <?php }while($row = $asbsenior->fetch_assoc())?> 
          </tbody>
        </table>
      </div>
