...
$sql = "SELECT * FROM dchs_data WHERE account_number LIKE '$search%' || full_name LIKE '%$search%' || dchs_number LIKE '$search%' ORDER BY account_number DESC";
...
if($total>0) {
  ...
  echo header("Location: dchsform.php");
}
...
<H3>MICRO SEGURO DCHS FORM NUMBER</H3></th>
      ...
      <form action ="dchssearch.php" method="get">
        <table>
