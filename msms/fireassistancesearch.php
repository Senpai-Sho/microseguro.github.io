...
$fireassistance = $con->query($sql) or die ($con->connect_error);
$row = $fireassistance->fetch_assoc();

$total = $fireassistance->num_rows;
    
if($total>0){
}else{
    echo header("Location: fireassistance.php");
}
...
.dropdown:hover .dropdown-content {
  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <form action ="fireassistancesearch.php" method="get">
        <table>
        ...
        <table class="table custom-table">
          ...
          <tbody>
            ...
            <?php if($row['Status'] == "Closed" || $row['Status'] == "Renewed"){
              ...
              <td><a href="fireassistanceform.php?AccountNumber=<?php echo $row['account_number'];?>"><i class="fa fa-caret-square-o-right" style="font-size:24px;color:green"></i></td>
            ...
            <?php }while($row = $fireassistance->fetch_assoc())?> 
          </tbody>
        </table>
      </div>
