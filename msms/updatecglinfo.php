...
<tr>
<td>Cycle:</td>
<td><input type="number" id="cycle" name="cycle" min="1" max="100" autocomplete="off">
...
<tr>
  ...
  <td><input type ="number" id="length" name="length"   autocomplete="off"> 
...
<td>Member Age:</td>
<td><input type="number" id="memberage" name="memberage" min="1" max="99" autocomplete="off"></td>
<td>Loan Amount:</td>
