...
$update = $con->query($sql) or die ($con->connect_error);
...
if (count($errors)==0){
 ...
 $sql = "UPDATE member_account SET first_name= '$fname', last_name = '$lname', middle_name = '$mname',
 middle_initial = '$minitial', gender = '$gender', member_address ='$address', civil_status ='$cstatus',
 date_member = '$datemember', birth_date = '$bdate' WHERE account_number = '$accountnumber'";
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="accountnumber"  name="accountnumber" value="<?php echo $row['account_number'];?>" autocomplete="off" READONLY>
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="firstname" name="firstname" value="<?php echo $row['first_name'];?>" autocomplete="off" >
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="middlename" name="middlename" value="<?php echo $row['middle_name'];?>" autocomplete="off">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="lastname" name="lastname" value="<?php echo $row['last_name'];?>" autocomplete="off">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="middleinitial" name="middleinitial" value="<?php echo $row['middle_initial'];?>" autocomplete="off">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="Address" name="Address" value="<?php echo $row['member_address'];?>" autocomplete="off">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <br>
    <input type="date" value="<?php echo $row['date_member'];?>" name="memberdate" class="form-control">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <br>
    <input type="date" value="<?php echo $row['birth_date'];?>"  name="bdate" class="form-control">
