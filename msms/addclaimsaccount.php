...
if(isset($_POST['submit'])){
    ...
    if(empty($productid)){
        $errors['pi'] = "Claims ID Required";
    }else if (mysqli_num_rows($acct)>0){
        $errors['pi'] = "Claims ID Exist";
    }

    if(empty($productname)){
        $errors['pm'] = "Claims Name Required";
    }
    ...
    if (count($errors) == 0){
        ...
        $sql1 = "INSERT INTO `claims_data`(`claims_id`,`claims_name`,`claims_classifaction`)
...
<body>
<ul>
  <li><a href="claimsaccount.php"><i class="fa fa-caret-square-o-left" style="font-size:24px;color:green"></a></i></li>
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="number" max="999" id="productid" name="productid" placeholder="<?php echo $row['claims_id']?>" autocomplete="off">
