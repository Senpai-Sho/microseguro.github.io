...
$total = $claimsinfo->num_rows;
    
if($total>0){
}else{
    echo header("Location: claimsinfo.php");
}
...
.dropdown:hover .dropdown-content {
  ...
  <div class="content">
    ...
    <div class="container">
      <br>
      <br>
      <h2 class="mb-5">Claims Information </h2>



      
<form action="searchclaims.php" method="get">
...
<?php if($_SESSION['Access'] == "Guest" || $_SESSION['Access'] ==  "MS-Master"){?>
            ...
            <?php echo "";?>
              ...
              <?php }else{?>
                <td><a href="claimsselect.php"><i class="fa fa-file-text-o" style="font-size:30px;color:green"></i></a> &nbsp;  &nbsp; </td>
          ...
          <tbody>
            ...
            <tr scope="row"> 
              ...
              <td><?php echo$row['Status']?></td>
                ...
                <td><a href="claimsdetails.php?AccountNumber=<?php echo $row['account_number'];?>"><i class="fa fa-file-text-o" style="font-size:24px;color:green"></i></a>   </td>
