...
.dropdown:hover .dropdown-content {
  ...
  <div class="content">
    ...
    <div class="container">
      <br>
      <br>
      <h2 class="mb-5">Select Account (Daily Confinement Benefits)</h2>

      <form action ="dcbsearch.php" method="get">
        <table>
        ...
        <table class="table custom-table">
          ...
          <tbody>
            ...
            <?php if($row['Status'] == "Closed" || $row['Status'] == "Renewed"){
              ...
              <td><a href="dcbform.php?AccountNumber=<?php echo $row['account_number'];?>"><i class="fa fa-caret-square-o-right" style="font-size:24px;color:green"></i></td>
