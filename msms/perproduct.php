...
h3,h1 ,h4{
  ...
  <form action="exportperproduct.php" method="POST">
...
<H3>MICRO SEGURO KPS-PRODUCT REPORT </H3></th>
...
<form action="" method="GET">
      ...
      <?php if(isset($_GET['from_date']) && isset($_GET['to_date']) && isset($_GET['productinfo']) ){
...
$query = "SELECT * FROM member_info WHERE date_insured BETWEEN '$from_date' AND '$to_date' AND loan_product = '$productinfo' ";
